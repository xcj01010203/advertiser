...
public class MD5 {
    ...
    public static void main(String args[]) {
    	MD5 m = new MD5();
        String str = m.getMD5("zjf8139");//
        System.out.println(str);
       /* System.out.println(str.toLowerCase());
        if (Array.getLength(args) == 0) {
            System.out.println("MD5 Test suite:");
            System.out.println("MD5(\"\"):".concat(String.valueOf(String.valueOf(m.getMD5("")))));
            System.out.println("MD5(\"admin\"):".concat(String.valueOf(String.valueOf(m.getMD5("admin")))));
            System.out.println("MD5(\"123456\"):".concat(String.valueOf(String.valueOf(m.getMD5("123456")))));
            System.out.println("MD5(\"abcdefghijklmnopqrstuvwxyz\"):".concat(String.valueOf(String.valueOf(m.getMD5("abcdefghijklmnopqrstuvwxyz")))));
            System.out.println("MD5(\"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789\"):".concat(String.valueOf(String.valueOf(m.getMD5("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789")))));
        } else {
            System.out.println(String.valueOf(String.valueOf((new StringBuffer("MD5(")).append(args[0]).append(")=").append(m.getMD5(args[0])))));
        }*/
    }
