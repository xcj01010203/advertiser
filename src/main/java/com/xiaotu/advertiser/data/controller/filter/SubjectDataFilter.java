...
/**
 * 题材数据查询条件
 * @author xuchangjian 2017年9月1日下午4:14:08
 */
public class SubjectDataFilter {

	private Integer areaId; 	//区域ID
	private List<Integer> channelIdList;	//频道ID列表 
	private List<Integer> channelLevelList; 	//频道级别列表
	...
	public List<Integer> getChannelLevelList() {
		return channelLevelList;
	}
	public void setChannelLevelList(List<Integer> channelLevelList) {
		this.channelLevelList = channelLevelList;
	}
